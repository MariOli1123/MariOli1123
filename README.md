...
| :--- | :--- | :--- | :--- |
| **Supervisor de Qualidade & Feedback** | Pipeline agendado que agrega avaliações de consultoria, usa IA para sintetizar reclamações críticas (nota < 7) e gera relatórios para consultores. | `n8n`, `OpenRouter`, `Google Sheets`, `Gmail API` | [Acessar](./MariOli1123/Supervisor-de-Qualidade-Feedback) |
